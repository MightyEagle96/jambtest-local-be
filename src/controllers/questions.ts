const testQuestions = [
  ...
  {
    question:
      "What was the name of the first Nigerian university, established in 1948?",
    options: [
      "University of Lagos",
  ...
  {
    question:
      "Which Nigerian leader introduced the Structural Adjustment Programme (SAP) in 1986?",
    options: [
      "Ibrahim Babangida",
      "Sani Abacha",
      "Shehu Shagari",
  ...
  {
    question:
      "What was the primary export commodity of Nigeria during the colonial era?",
    options: ["Oil", "Cocoa", "Groundnuts", "Timber"],
  },
  {
    question:
      "Which pre-colonial empire was known for its bronze plaques and sculptures in Nigeria?",
  ...
  {
    question:
      "Which programming language is primarily used for web development and is known for its asynchronous capabilities?",
  ...
  {
    question:
      "Who is the current Speaker of the U.S. House of Representatives as of October 2025?",
    options: [
      "Nancy Pelosi",
      "Kevin McCarthy",
      "Mike Johnson",
  ...
  {
    question:
      "Which political party is associated with the color blue in the U.S.?",
    options: [
      "Republican Party",
      "Democratic Party",
      "Libertarian Party",
  ...
  {
    question:
      "What is the Electoral College's role in U.S. presidential elections?",
    options: [
      "Vetting Candidates",
  ...
  {
    question:
      "Which part of the brain regulates basic bodily functions like breathing and heart rate?",
  ...
  {
    question:
      "Which structure in plant cells is responsible for storing water and nutrients?",
    options: ["Vacuole", "Chloroplast", "Cell Wall", "Nucleus"],
  },
  // Philosophy
  {
    question:
      "Who is known for the philosophical concept of the 'Categorical Imperative'?",
    options: [
      "John Stuart Mill",
      "Immanuel Kant",
      "Friedrich Nietzsche",
